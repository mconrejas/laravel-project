...
( function( $ ) {
    $.fn.TradingViewWidget = function( params ) {
        ...
        widget.getSaveTimeframe = function (){
            var timeframe = localStorage.getItem('bzx_save_timeframe') ? localStorage.getItem('bzx_save_timeframe').toUpperCase() : '1D';
            return timeframe;
        }
        ...
        widget.opt = $.extend( {
            ...
            serverTimeUrl: '',
            last_fid: 0,
            theme: widget.getParameterByName( 'theme' ) || 'Light',
            width: '100%',
            height: '380px',
            symbol: 'BTC/ETH',
            interval: 'D',
