...
class Dash extends Coin
{
     ...
     * @var string
     */
    protected $apiRawTx = 'api/v2/get_tx/DASH/[[var1]]';

    /**
     * @var string
     */
    protected $apiBlockHash = 'api/v2/get_blockhash/DASH/[[var1]]';

    /**
     * @var string
     */
    protected $apiBlockCount = 'api/v2/get_info/DASH';

    /**
     * @var string
     */
    protected $apiBlock = 'api/v2/get_block/DASH/[[var1]]';

    /**
     * @var string
     */
    protected $apiAddress = 'api/v2/get_tx_received/DASH/[[var1]]';

    /**
     * @var string
     */
    protected $apiAddressExplorer = 'address/DASH/[[var1]]';

    /**
     * @var string
     */
    protected $txExplorer = 'tx/DASH/'; // full tx explorer link
