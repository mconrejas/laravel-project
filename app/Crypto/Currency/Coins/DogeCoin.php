...
class DogeCoin extends Coin
{
     ...
     * @var string
     */
    protected $apiRawTx = 'api/v2/get_tx/DOGE/[[var1]]';

    /**
     * @var string
     */
    protected $apiBlockHash = 'api/v2/get_blockhash/DOGE/[[var1]]';

    /**
     * @var string
     */
    protected $apiBlockCount = 'api/v2/get_info/DOGE';

    /**
     * @var string
     */
    protected $apiBlock = 'api/v2/get_block/DOGE/[[var1]]';

    /**
     * @var string
     */
    protected $apiAddress = 'api/v2/get_tx_received/DOGE/[[var1]]';

    /**
     * @var string
     */
    protected $apiAddressExplorer = 'address/DOGE/[[var1]]';

    /**
     * @var string
     */
    protected $txExplorer = 'tx/DOGE/'; // full tx explorer link
